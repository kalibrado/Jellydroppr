...
if test /tmp/code-server/bin/code-server; then
    ...
    yzhang.markdown-all-in-one Zignd.html-css-class-completion ms-python.python donjayamanne.githistory eamodio.gitlens github.github-vscode-theme \ 
    oderwat.indent-rainbow christian-kohler.path-intellisense mhutchie.git-graph Gruntfuggly.todo-tree github.vscode-pull-request-github marp-team.marp-vscode \ 
    shuworks.vscode-table-formatter njpwerner.autodocstring"

    /tmp/code-server/bin/code-server --install-extension $pkglist
